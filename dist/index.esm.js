...
export { copy, date, each, extend, fix0, getNumberWithDec, getStdDeviation, gettNumberAverage, gettNumberVariance, is, isArray, isBoolean, isError, isFunction, isNull, isNumber, isObject, isRegexp, isString, isUndefined, isValidArray, labelReplace, labelReplaceExp, merge, numberFormat, queryString, random, serialize, shuffle, toArray, toDate, toUnderlineName };
